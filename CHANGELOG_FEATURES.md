...
> **v1.2.0 更新**：本文件下方的默认密码、角色和密码接口描述保留为历史记录。当前行为以 [`releases/v1.2.0.md`](releases/v1.2.0.md) 和 [`releases/v1.1.0.md`](releases/v1.1.0.md) 为准；v1.2 在 v1.1 基础上加入账号计费、批量管理、可回滚持久化、前端资源拆分与新版登录视觉界面。
